        ...
        <div className="profile-bio">
          <div>
            <div className="coverImageContainer">
              <img
                src={loggedInUser[0]?.coverImage || "https://cdn.pixabay.com/photo/2016/08/08/09/17/avatar-1577909_960_720.png"}
                alt=""
              ...
              <div className="hoverCoverImage">
                <div className="imageIcon_tweetButton">
                  <label htmlFor="image" className='imageIcon'>
                    {isLoading ? <LockResetIcon className='photoIcon photoIconDisabled' /> : <CenterFocusWeakIcon />}
                  </label>
            ...
            <div className="avatar-img">
              <div className="avatarContainer">
                <img
                  src={loggedInUser[0]?.profileImage || "https://cdn.pixabay.com/photo/2016/08/08/09/17/avatar-1577909_960_720.png"}
                  alt=""
                  className="avatar"
                />
              ...
              <div className="infoContainer">
                ...
                <div className="locationAndLink">
                  ...
                  {loggedInUser[0]?.plan && <p className='subInfo'>{t('Profile2')}: {getPlanName(loggedInUser[0]?.plan)}</p>}
                </div>
              </div>
