...
//                         <button className="action-button" onClick={sendOtp}>{t('Lani')}</button>
//                     </div>
//                     <div className="input">
...
//                     </div>
//                     <button className="action-button" onClick={verifyOtp}>{t('Lani3')}</button>
//                 </div>
//             )}
...
//             <div className="action">
//                 <button className="action-button" onClick={handleApplyLanguage}>{t('Lani4')}</button>
//             </div>
//         </div>
//     );
// };
...
const Language = () => {
    ...
    return (
        <div className="language-container">
            ...
            <div className="select-container">
                <select className="select" value={selectedLang} onChange={(e) => changeLanguage(e.target.value)}>
                    {languages.map((lng) => (
                        <option key={lng.code} value={lng.code}>
                            {lng.lang}
                        </option>
